...
INSERT INTO users(ws_id, email, username, password_hash)
  VALUES (1, 'test2@acme.org', 'Ivena', '$argon2id$v=19$m=19456,t=2,p=1$MxGhY+ib/kplwBPLa7u2ug$c5h9u7Sc8Px8J5+qgNdOjSY7ZJO2QN4rugKpapGW4XU'),
...
-- insert unnamed chat
INSERT INTO chats(ws_id, chat_type, members)
  VALUES (1, 'single', '{1,2}'),
(1, 'group', '{1,3,4}');
